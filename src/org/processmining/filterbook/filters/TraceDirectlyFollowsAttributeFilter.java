...
public class TraceDirectlyFollowsAttributeFilter extends TraceDirectlyFollowsGlobalAttributeFilter {
	 ...
	 */
	public static final String NAME = "Select on two directly-following attribute values";

	public TraceDirectlyFollowsAttributeFilter(XLog log, Parameters parameters, ComputationCell cell) {
		super(NAME, log, parameters, cell);
	}

	public TraceDirectlyFollowsAttributeFilter(String name, XLog log, Parameters parameters, ComputationCell cell) {
		super(name, log, parameters, cell);
	}
