...
public class TraceVariantSlowestClassifierFilter extends TraceVariantTimeAbstractClassifierFilter {
	...
	public TraceVariantSlowestClassifierFilter(XLog log, Parameters parameters, ComputationCell cell) {
		super(NAME, log, parameters, cell);
	}

	public TraceVariantSlowestClassifierFilter(String name, XLog log, Parameters parameters, ComputationCell cell) {
		super(name, log, parameters, cell);
	}
