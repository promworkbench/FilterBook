...
import org.processmining.filterbook.filters.select.global.TraceVariantAbstractGlobalAttributeFilter;
...
public abstract class TraceVariantAbstractAttributeFilter extends TraceVariantAbstractGlobalAttributeFilter{
	...
	public TraceVariantAbstractAttributeFilter(String name, XLog log, Parameters parameters, ComputationCell cell) {
		super(name, log, parameters, cell);
	}
