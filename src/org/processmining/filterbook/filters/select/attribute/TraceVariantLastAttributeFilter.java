...
public class TraceVariantLastAttributeFilter extends TraceVariantAbstractAttributeFilter {
	...
	public TraceVariantLastAttributeFilter(XLog log, Parameters parameters, ComputationCell cell) {
		super(NAME, log, parameters, cell);
	}

	public TraceVariantLastAttributeFilter(String name, XLog log, Parameters parameters, ComputationCell cell) {
		super(name, log, parameters, cell);
	}
