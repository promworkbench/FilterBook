...
public class TraceVariantSlowestAttributeFilter extends TraceVariantTimeAbstractAttributeFilter {
	...
	public TraceVariantSlowestAttributeFilter(XLog log, Parameters parameters, ComputationCell cell) {
		super(NAME, log, parameters, cell);
	}

	public TraceVariantSlowestAttributeFilter(String name, XLog log, Parameters parameters, ComputationCell cell) {
		super(name, log, parameters, cell);
	}
