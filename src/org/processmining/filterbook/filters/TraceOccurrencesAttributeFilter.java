...
public class TraceOccurrencesAttributeFilter extends Filter {
	...
	public TraceOccurrencesAttributeFilter(String name, XLog log, Parameters parameters, ComputationCell cell) {
		super(name, parameters, cell);
		setLog(log);
		cachedLog = null;
		occurrences = new HashMap<List<String>, Integer>();
	...
	private List<String> getValues(XTrace trace, XAttribute attribute) {
		List<String> values = new ArrayList<String>();
		for (XEvent event : trace) {
			String value = event.getAttributes().get(attribute.getKey()).toString();
			values.add(value);
		}
		return values;
	}
	...
	private void setOccurrences() {
		...
		for (XTrace trace : getLog()) {
			List<String> values = getValues(trace, attribute);
