...
public class TraceVariantFastestAttributeFilter extends TraceVariantTimeAbstractAttributeFilter {
	...
	public TraceVariantFastestAttributeFilter(String name, XLog log, Parameters parameters, ComputationCell cell) {
		super(name, log, parameters, cell);
	}
