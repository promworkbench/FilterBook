...
public class TraceVariantFastestGlobalAttributeFilter extends TraceVariantTimeAbstractGlobalAttributeFilter  {

	/**
	 * The name of this filter.
	 */
	public static final String NAME = "Select fastest variant using global attribute value";

	public TraceVariantFastestGlobalAttributeFilter(XLog log, Parameters parameters, ComputationCell cell) {
		super(NAME, log, parameters, cell);
	}

	public TraceVariantFastestGlobalAttributeFilter(String name, XLog log, Parameters parameters, ComputationCell cell) {
		super(name, log, parameters, cell);
	}
