...
public class TraceVariantFastestClassifierFilter extends TraceVariantTimeAbstractClassifierFilter {

	/**
	 * The name of this filter.
	 */
	public static final String NAME = "Select fastest variant using classifier value";

	public TraceVariantFastestClassifierFilter(XLog log, Parameters parameters, ComputationCell cell) {
		super(NAME, log, parameters, cell);
	}

	public TraceVariantFastestClassifierFilter(String name, XLog log, Parameters parameters, ComputationCell cell) {
		super(name, log, parameters, cell);
	}
